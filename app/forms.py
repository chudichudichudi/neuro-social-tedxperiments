...
DateTimeField, RadioField, FormField, SelectField, Form as wtfForm
...
class CronotiposForm(Form):
    ...
    pregunta_10 = FormField(HourForm,
    ...
    pregunta_18 = FormField(HourForm,
    ...
    pregunta_24 = RadioField(u'24 - Un amigo lo invita a hacer ejercicio o practicar un deporte entre las 22:00 y las 23:00. Pensando en los horarios en los que Ud. se siente mejor, ¿cómo cree que sería su rendimiento?',
        choices=[(u'A', u'Muy bueno'),
                 ...
                 (u'C', u'Pobre'),
                 (u'D', u'Malo')])
    #esto 25, 26 es un select field con horas
    pregunta_25 = RadioField(u'25 - Si Ud. pudiera elegir los horarios de su trabajo, el cual es realmente entretenido y en el cual se le paga de acuerdo a su rendimiento, suponiendo que trabaja 5 horas corridas, ¿qué horario elegiría? ',
                             choices=[(u'A', u'Muy bueno'),
                                      (u'B', u'Razonable'),
                                      (u'C', u'Pobre'),
                                      (u'D', u'Malo')])
    pregunta_26 = RadioField(u'26 - ¿A qué hora del día se siente mejor habitualmente (más fresco, más activo, más despierto, más capaz, etc.)?',
                             choices=[(u'A', u'Muy bueno'),
                                      (u'B', u'Razonable'),
                                      (u'C', u'Pobre'),
                                      (u'D', u'Malo')])
